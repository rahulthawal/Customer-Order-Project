...
{
  public  void addCustomer (int custNo, String custName,
    String street, String city, String state, String zipCode,
    String phoneNo) throws SQLException, ClassNotFoundException {
      ...
      //c = DriverManager.getConnection("jdbc:sqlite:test.db");
        Connection conn =
        DriverManager.getConnection("jdbc:sqlite:D:\\DATABASE_CONCEPT\\Customer_Purchase\\project_beta.db");
  ...
  public  void addStockItem (int stockNo, String description,
  ...
  public  void enterOrder (int orderNo, int custNo,
  ...
  public void addLineItem (int lineNo, int orderNo,
  ...
  public  void checkStockItem (int stockNo)
    throws SQLException {
 ...
 {
     POManager p = new POManager();
     p.addCustomer(1,"rahul" ,"3542 D' Avinci Way" ,"Melbourne" ,"FL" ,"32901" ,"3214195725" );
